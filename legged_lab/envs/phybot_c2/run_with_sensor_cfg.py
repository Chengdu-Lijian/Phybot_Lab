...
@configclass
class PhybotC2RunWithSensorFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/phybot_c2/datasets/motion_visualization/run.txt"]
    device: str = "cuda:0"
...
@configclass
class PhybotC2RunWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/phybot_c2/datasets/motion_amp_expert/run.txt"]
