...
from legged_gym.envs.phybot_mini.phybot_mini_config import Phybot_miniCfg, Phybot_miniCfgPPO
from legged_gym.envs.phybot_mini.phybot_mini_env import Phybot_mini_Robot
...
task_registry.register( "phybot_mini", Phybot_mini_Robot, Phybot_miniCfg(), Phybot_miniCfgPPO())
